...
function computeQuarterlyNps(records: SurveyRecord[]): QuarterData[] {
...
export function OverviewNpsChart({ records }: { records: SurveyRecord[] }) {
  const data = computeQuarterlyNps(records);
